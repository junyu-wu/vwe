;;; vwe-style-terminal-theme.el --- Dark theme         -binding: t; -*-
...
(defvar vwe-style-terminal--faces
  '(;; default
...
(vwe-style--load 'vwe-style-terminal vwe-style-terminal--colors vwe-style-terminal--faces)
(vwe-style--load-theme-file)

(provide-theme 'vwe-style-terminal)
;;; vwe-style-terminal-theme.el ends here
