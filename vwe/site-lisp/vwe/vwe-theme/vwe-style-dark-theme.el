...
(defvar vwe-style-dark--faces
  '(;; default
    ...
    (org-level-1 :inherit bold :foreground ,orangered)
    (org-level-2 :inherit bold :foreground ,orange)
    (org-level-3 :inherit bold :foreground ,yellow)
	(org-level-4 :inherit bold :foreground ,green)
