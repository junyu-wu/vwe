...
(defun vwe-edit-bound-mode-disable ()
  "Disable mode."
  (vwe-edit-bound--remove-overlays)
  (remove-hook 'after-change-functions #'vwe-edit-bound--redraw t)
  (remove-hook 'before-change-functions #'vwe-edit-bound--redraw t)
  (remove-hook 'window-scroll-functions #'vwe-edit-bound--redraw-for-scroll t)
  (remove-hook 'window-configuration-change-hook #'vwe-edit-bound--show)
  (add-hook 'post-self-insert-hook #'vwe-edit-bound--show t)
