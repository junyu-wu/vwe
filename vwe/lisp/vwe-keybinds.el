  ...
  (mum-key-define layout
				  (("window" :face (:background "DarkOrange" :foreground "white" :weight bold))
				   (("2" split-window-vertically "split vertically")
					...
					("e" enlarge-window "win height+")
					("s" shrink-window "win height-")
					("E" enlarge-window-horizontally "win width+")
					("S" shrink-window-horizontally "win width-")
					("b" balance-windows "win balance")
					("u" mum-layout--windmove-up "win move up")
					("d" mum-layout--windmove-down "win move down")
					("l" mum-layout--windmove-left "win move left")
					("r" mum-layout--windmove-right "win move right")
					("U" mum-layout--swap-up-buffer "swap up buffer")
					("D" mum-layout--swap-down-buffer "swap down buffer")
					("L" mum-layout--swap-left-buffer "swap left buffer")
					("R" mum-layout--swap-right-buffer "swap right buffer")
					("RET" mum-key:global "global" :footer t :face (:background "DarkOrange" :foreground "white" :weight bold)))))
