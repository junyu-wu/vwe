...
(defvar vwe@keybind--default-list
  '(("<f1>"                               vwe-key:global)
	...
	("M-w"                                vwe@lib--kill-ring-save)
	("C-w"                                vwe@lib--kill-region)
	...
	("M-h"                                vwe-edit-toggle-case--select-convert)
  ...
  (vwe-key-define global
				  (("global" :face (:background "DarkOrange" :foreground "white" :weight bold))
				   (("B" ibuffer "ibuffer")
					...
					("[" vwe-layout-config--store "store layout")
					("]" vwe-layout-config--toggle-config "toggle layout")
					("." vwe-layout-config--toggle-last-config "toggle last layout")
					("*" calendar "calendar")
  ...
  (vwe-key-define org
				  ("org"
				   (("l" org-store-link "store link")
					...
					("I" vwe@org--insert-link-and-clipboard-image "insert image")
					("r" org-redisplay-inline-images "redisplay images")
					...
					("/" vwe@org--emphasis-text "emphasis text")
					...
					("V" vwe@org--reveal-load "reveal load")
