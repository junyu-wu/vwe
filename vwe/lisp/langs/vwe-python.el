...
(vwe@lib--pkg python
  ...
  :config (;;
		   ...
		   ;; 	 :init ((add-hook 'python-mode-hook #'py-autopep8-mode)))
		   ...
		   ;;
		   (vwe@lib--pkg conda
			 :config ((conda-env-initialize-interactive-shells)): variable((setq conda-anaconda-home(getenv "CONDA_HOME")))))
  :variable ((setq indent-tabs-mode nil
				   python-indent-offset 4
				   python-shell-interpreter "python3")))

(provide 'vwe-python); ; ; vwe-python.el ends here
